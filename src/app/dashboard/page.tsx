...
export default function Dashboard() {
  ...
  return (
    <main className="m-auto flex min-h-screen w-full max-w-3xl flex-col items-center justify-start py-10 px-10 bg-white dark:bg-black sm:items-start">
      ...
      <div className="mx-auto min-w-100 flex flex-col items-center gap-6 text-center sm:items-start sm:text-left">
        ...
        <div className="flex flex-row justify-between items-center w-full">
          <p>Migration inicial de Countries:</p>
          <form action={migrate}>
